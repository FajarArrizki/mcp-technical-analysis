...
export interface KlingerOscillatorData {
  // Klinger Oscillator value
  klinger: number

  // Short-term EMA (34 periods)
  shortEMA: number

  // Long-term EMA (55 periods)
  longEMA: number

  // Volume Force (VF) - the base calculation
  volumeForce: number

  // Trend direction
  trend: 'bullish' | 'bearish' | 'neutral'

  // Signal line (typically 13-period MA of Klinger)
  signalLine: number
 ...
 */
export function getKlingerInterpretation(klinger: KlingerOscillatorData): string {
 ...
 */
export function getKlingerVolumeStrength(klinger: KlingerOscillatorData): number {
