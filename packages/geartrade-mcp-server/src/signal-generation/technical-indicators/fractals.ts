...
export interface FractalData {
  bullishFractals: Array<{ index: number; value: number }>
  bearishFractals: Array<{ index: number; value: number }>
  currentBullishFractal: number | null
  currentBearishFractal: number | null
  signal: 'bullish_reversal' | 'bearish_reversal' | 'neutral' | null
}
...
export function calculateFractals(
  ...
  const bullishFractals: Array<{ index: number; value: number }> = []
  const bearishFractals: Array<{ index: number; value: number }> = []
  ...
  let signal: 'bullish_reversal' | 'bearish_reversal' | 'neutral' | null = null
