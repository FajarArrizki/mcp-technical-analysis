...
export interface PivotPointsData {
  ...
  currentPosition: 'above_r3' | 'between_r2_r3' | 'between_r1_r2' | 'between_pp_r1' | 'between_pp_s1' | 'between_s1_s2' | 'between_s2_s3' | 'below_s3' | null
}
...
export function getPricePositionRelativeToPivot(
  currentPrice: number,
  pivotData: PivotPointsData
): 'above_r3' | 'between_r2_r3' | 'between_r1_r2' | 'between_pp_r1' | 'between_pp_s1' | 'between_s1_s2' | 'between_s2_s3' | 'below_s3' {
  ...
  if (currentPrice >= resistance3) return 'above_r3'
  if (currentPrice >= resistance2) return 'between_r2_r3'
  if (currentPrice >= resistance1) return 'between_r1_r2'
  if (currentPrice >= pivotPoint) return 'between_pp_r1'
  if (currentPrice >= support1) return 'between_pp_s1'
  if (currentPrice >= support2) return 'between_s1_s2'
  if (currentPrice >= support3) return 'between_s2_s3'
  return 'below_s3'
}
