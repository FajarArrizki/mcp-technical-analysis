...
function fullWidthRow(text: string | null | undefined, color: string = 'cyan'): string {
...
function tableRow(label: string, value: string | number | null | undefined, valueColor?: string): string {
...
export function createSection(title: string, content: string[] | string): string {
...
export function formatKeyValue(key: string, value: string | number, valueColor?: string): string {
