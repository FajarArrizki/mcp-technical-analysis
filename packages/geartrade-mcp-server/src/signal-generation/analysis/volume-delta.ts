...
export interface CVDHistoryPoint {
  timestamp: number
  cvdBuyer: number
  cvdSeller: number
  cvdDelta: number
 ...
 */
export function calculateCumulativeVolumeDelta(
  historicalData: HistoricalDataPoint[],
  currentPrice: number
): CumulativeVolumeDelta | null {
  ...
  const cvdHistory: CVDHistoryPoint[] = [] // Track CVD over time for trend analysis
