 ...
 */
export async function getL2OrderBook(coin, nSigFigs) {
    try {
        const params = { type: 'l2Book', coin };
 ...
 */
export async function getUserOpenOrders(address) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'openOrders',
            user: address
 ...
 * @param address - User wallet address
 */
export async function getUserFrontendOpenOrders(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 */
export async function getUserFills(address, aggregateByTime = false) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'userFills',
            user: address,
 ...
 * @param aggregateByTime - When true, partial fills are combined
 */
export async function getUserFillsByTime(address, startTime, endTime, aggregateByTime = false) {
    try {
        const params = {
 ...
 * @param address - User wallet address
 */
export async function getUserHistoricalOrders(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 */
export async function getOrderStatus(address, oid) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'orderStatus',
            user: address,
 ...
 * @param address - User wallet address
 */
export async function getUserRateLimit(address) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'userRateLimit',
            user: address
 ...
 * @param address - User wallet address
 */
export async function getUserSubaccounts(address) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'subAccounts',
            user: address
 ...
 */
export async function getVaultDetails(vaultAddress, userAddress) {
    try {
        const params = {
            type: 'vaultDetails',
            vaultAddress
 ...
 * @param address - User wallet address
 */
export async function getUserVaultEquities(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 * @param address - User wallet address
 */
export async function getUserDelegations(address) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'delegations',
            user: address
 ...
 * @param address - User wallet address
 */
export async function getUserDelegatorSummary(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 * @param address - User wallet address
 */
export async function getUserDelegatorHistory(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 * @param address - User wallet address
 */
export async function getUserDelegatorRewards(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 * @param address - User wallet address
 */
export async function getUserSpotBalances(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 */
export async function getPerpMetadata(dex) {
    try {
        const params = { type: 'meta' };
        if (dex) {
            params.dex = dex;
        }
        const result = await fetchHyperliquid('/info', params);
 ...
 */
export async function getPerpDexs() {
    try {
 ...
 * @param endTime - End time in milliseconds (optional)
 */
export async function getFundingHistory(coin, startTime, endTime) {
    try {
        const params = {
            type: 'fundingHistory',
            coin,
 ...
 * @param address - User wallet address
 */
export async function getUserTwapSliceFills(address) {
    try {
        const result = await fetchHyperliquid('/info', {
 ...
 */
export async function getMaxBuilderFee(userAddress, builderAddress) {
    try {
        const result = await fetchHyperliquid('/info', {
            type: 'maxBuilderFee',
            user: userAddress,
