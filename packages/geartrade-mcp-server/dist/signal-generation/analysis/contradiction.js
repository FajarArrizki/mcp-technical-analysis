 ...
 */
export function detectContradictions(signal, indicators, trendAlignment) {
    ...
    const aroonVsEmaContradiction = (!!indicators?.aroon) &&
    ...
    const dualOverboughtDetected = (stochasticK >= 90) &&
