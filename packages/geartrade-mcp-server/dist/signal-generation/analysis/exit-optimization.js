 ...
 */
function calculateTPFromClusters(entryPrice, side, clusters, minDistance = 1 // 1% minimum distance
) {
 ...
 */
function calculateSLFromNoiseZones(entryPrice, side, clusters, atr // ATR for noise calculation
) {
 ...
 */
function calculateTrailingStopDistance(_side, atr, volatility // Volatility %
) {
 ...
 */
export function optimizeExitLevels(position, futuresData, atr, volatility) {
    const reasons = [];
    let optimalTP = null;
    let optimalSL = null;
