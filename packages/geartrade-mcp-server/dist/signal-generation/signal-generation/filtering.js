 ...
 */
export function shouldAutoExecute(signal, _indicators, _accountState = null, tradingConfig = null) {
...
export function checkRiskLimits(signal, accountState, tradingConfig = null) {
    const TRADING_CONFIG = tradingConfig || {
        safety: {
            maxRiskPerTrade: 2.0,
            maxOpenPositions: 2,
