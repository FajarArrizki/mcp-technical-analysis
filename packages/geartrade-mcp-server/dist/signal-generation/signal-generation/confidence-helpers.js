 ...
 */
export function calculateRecentMomentum(historicalData, indicators, periods = 3) {
 ...
 */
export function checkMajorIndicatorsAlignment(indicators, direction) {
    if (!indicators) {
 ...
 */
export function calculateAdaptiveFlipThreshold(trendStrength) {
 ...
 */
export function getAdaptiveWeights(trendStrength, volatilityHigh, marketRegime) {
 ...
 */
export function evaluateTieredWeights(indicators, _direction) {
    if (!indicators) {
        return {
            tier1Score: 0,
            tier2Score: 0,
 ...
 */
export function calculateWeightedMedian(indicators, bullishScore, bearishScore) {
    if (!indicators) {
        return null;
    }
 ...
 */
export function calculatePartialConfidence(bullishPercent, bearishPercent, baseConfidence = 0.3) {
 ...
 */
export function calculateAdaptiveMinConfidence(trendStrength, contradictionScore, volatility, baseMinConf = 0.32) {
 ...
 */
export function calculateRelativeEVThreshold(signals, baseThreshold = 0.30) {
