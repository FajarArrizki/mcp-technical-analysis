...
import { calculateMcGinleyDynamic } from './signal-generation/technical-indicators/mcginley-dynamic';
import { calculateRainbowMA } from './signal-generation/technical-indicators/rainbow-ma';
import { calculateKaufmanAdaptiveMA } from './signal-generation/technical-indicators/kaufman-adaptive-ma';
...
}, async ({ prices, period = 20, percentage = 2.5, maType = 'sma' }) => {
    try {
...
server.registerTool('price_channel', {
...
server.registerTool('mcginley_dynamic', {
...
server.registerTool('rainbow_ma', {
...
server.registerTool('kaufman_adaptive_ma', {
...
server.registerTool('detrended_price_oscillator', {
...
server.registerTool('relative_vigor_index', {
...
server.registerTool('gator_oscillator', {
...
server.registerTool('fisher_transform', {
...
server.registerTool('know_sure_thing', {
...
server.registerTool('chande_momentum_oscillator', {
...
server.registerTool('bull_bear_power', {
...
server.registerTool('true_strength_index', {
...
server.registerTool('percentage_price_oscillator', {
...
server.registerTool('accelerator_oscillator', {
...
server.registerTool('schaff_trend_cycle', {
...
server.registerTool('coppock_curve', {
    title: 'Coppock Curve',
...
server.registerTool('klinger_oscillator', {
...
server.registerTool('volume_oscillator', {
...
server.registerTool('ease_of_movement', {
...
server.registerTool('price_volume_trend', {
...
server.registerTool('positive_volume_index', {
...
server.registerTool('volume_roc', {
...
server.registerTool('anchored_vwap', {
    title: 'Anchored VWAP',
...
server.registerTool('chaikin_money_flow', {
...
server.registerTool('volume_zone_oscillator', {
...
server.registerTool('chaikin_volatility', {
...
server.registerTool('mass_index', {
    title: 'Mass Index',
...
server.registerTool('ulcer_index', {
    title: 'Ulcer Index',
...
server.registerTool('bollinger_percent_b', {
...
server.registerTool('bollinger_band_width', {
...
server.registerTool('historical_volatility', {
...
server.registerTool('center_of_gravity', {
...
server.registerTool('chaikin_oscillator', {
...
server.registerTool('stochastic_rsi', {
...
server.registerTool('money_flow_index', {
...
server.registerTool('ultimate_oscillator', {
...
server.registerTool('balance_of_power', {
...
server.registerTool('advance_decline_line', {
...
server.registerTool('zigzag_indicator', {
...
server.registerTool('trend_detection', {
...
server.registerTool('hull_moving_average', {
...
server.registerTool('weighted_moving_average', {
...
server.registerTool('smoothed_moving_average', {
...
server.registerTool('double_exponential_moving_average', {
...
server.registerTool('triple_exponential_moving_average', {
...
server.registerTool('pivot_camarilla', {
...
server.registerTool('fibonacci_retracement', {
...
server.registerTool('standard_pivot_points', {
...
server.registerTool('keltner_channels', {
...
server.registerTool('donchian_channels', {
...
server.registerTool('awesome_oscillator', {
...
server.registerTool('ichimoku_cloud', {
...
server.registerTool('momentum_indicator', {
...
server.registerTool('rate_of_change', {
...
server.registerTool('force_index', {
    title: 'Force Index',
...
server.registerTool('supertrend', {
    title: 'SuperTrend',
...
server.registerTool('linear_regression', {
