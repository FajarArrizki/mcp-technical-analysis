...
export class MigrationManager {
     ...
     */
    async executeD1MigrationForBinding(dependency, databaseBinding) {
        const result = {
     ...
     */
    async runWranglerD1Migrations(dependencyName, wranglerConfigPath, databaseBinding) {
        ...
        try {
            ...
            throw new CLIError(`Failed to execute D1 migrations for ${dependencyName}:${databaseBinding}: ${error.message}`, "Make sure wrangler is installed and you have the necessary permissions", 1);
        }
    }
}
